...
export default function EducationCenter() {
  ...
  return (
    <div className="min-h-screen bg-surface-dark">
      {/* Header */}
      <div className="bg-surface-dark-secondary border-b border-white/10 sticky top-0 z-10">
            ...
            {view === "home" && (
              <div className="relative w-full sm:w-80">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 bg-surface-dark border border-white/10 rounded-xl text-sm text-gray-100 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-brand-400/40 focus:border-transparent transition-all"
                />
              </div>
            )}
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        {view === "home" && !searchQuery && (
          <div className="space-y-8">
            {/* Progress overview */}
            <div className="bg-gradient-to-r from-brand-400 via-purple-500 to-pink-500 rounded-2xl p-6 text-white">
            ...
            <button
              ...
              className="w-full bg-surface-dark-secondary border border-white/10 rounded-2xl p-5 flex items-center justify-between hover:border-brand-400/30 transition-all group"
            >
              <div className="flex items-center gap-4">
              ...
              <Sparkles className="h-5 w-5 text-gray-400 group-hover:text-brand-400 transition-colors" />
            </button>

            {/* Fun fact */}
            <div className="bg-warn/10 border border-warn/20 rounded-2xl p-5">
        ...
        {view === "home" && searchQuery && (
          <div className="space-y-4">
            ...
            {searchResults.length === 0 ? (
              <div className="bg-surface-dark-secondary rounded-2xl p-8 text-center">
              ...
              <div className="space-y-2">
                {searchResults.map(({ category, topic }) => (
                  <button
                    ...
                    className="w-full bg-surface-dark-secondary border border-white/10 rounded-xl p-4 flex items-center justify-between hover:border-brand-400/30 transition-all text-left"
                  >
                    <div>

        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-24 sm:pt-24 sm:pb-32">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-10 max-w-3xl mx-auto leading-relaxed">
              ...
              informed investment decisions with our comprehensive platform.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex gap-8 text-sm">
              <Link href="/auth/login" className="text-gray-400 hover:text-primary-400 transition-colors">
                Sign In
              </Link>
              <Link href="/auth/register" className="text-gray-400 hover:text-primary-400 transition-colors">
                Get Started
              </Link>
              <Link href="/israeli-stocks" className="text-gray-400 hover:text-primary-400 transition-colors">
                Demo
              </Link>
            </div>
          </div>
